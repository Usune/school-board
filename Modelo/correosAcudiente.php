    ...
    class CorreosAcudiente {
        ...
        public function enviarCorreo($idCurso, $tipoInfo, $titulo, $descripcion){
            ...
            if($f1){
                                ...
                                <body style="
                                    ...
                                    ">
                                        ...
                                        <p class="texto1" style="
                                            ...
                                            text-align: justify; 
                                            margin-bottom: 20px;
                                        ">Se ha subido un nuevo '.$tipoInfo.' para el estudiante <span class="destacar" style="
                                            font-weight: bold;
                                            color: #2F5494;
                                        ...
                                        <div style="margin-top:0px;margin-bottom:0px;text-align:center; ">
                                            ...
                                            ">'.$descripcion.' Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aut illum, molestiae, veniam porro repellat deserunt commodi laboriosam fuga similique tempore, nam laborum ducimus. Maiores excepturi repudiandae consectetur dolorum, adipisci commodi.</p>
                                        </div>
                                        <p style="
                                            font-size:12px;
                                            margin-bottom: 10px;
                ...
                echo '<script>alert("No hay acudientes registrados para enviar el '.$tipoInfo.'")</script>';
