                ...
                try {
                    ...
                    <html lang="en">
                        <head>
                            ...
                            <body>
                                <table width="100%" role="presentation" cellspacing="0" cellpadding="0" style="max-width:500px; margin-left:auto;margin-right:auto; padding:15px; border:2px solid #ccc; border-radius:20px 20px 0 0;">
                                    <tbody>
                                        <tr style="width:100%">
                                            <td>
                                                ...
                                                <h2 style="font-size: 30px;font-weight: 700;line-height: 40px;margin-bottom: 30px;color: #2F5494;text-align: center;"><strong>RECUPERACIÓN DE CLAVE</strong></h2>
                                                <p style="font-size:15px; line-height:24px; margin-top: 0px;margin-bottom: 10px;color: #000;-webkit-font-smoothing: antialiased;-moz-osx-font-smoothing: grayscale;text-align: left;">Hola '.$nombres[0].' '.$apellidos[0].', se ha generado con exito su nueva clave.</p>
                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="margin-top:0px;margin-bottom:0px;text-align:center;">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <p style="font-size:24px; text-align:center; line-height:35px; width:180px; margin-top:30px; margin-bottom:40px; color:#000; background-color:#ccc; -webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;">'.$nuevaClave.'</p>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                ...
                                <p width="100%" style="max-width:500px; margin:auto; font-size:12px; line-height:40px; margin-top: 0px;margin-bottom: 20px;color: #fff;-webkit-font-smoothing: antialiased;-moz-osx-font-smoothing: grayscale;text-align: center; background-color: #2F5494; border-radius:0 0 20px 20px;">&reg; School Board - 2023</p>
                            </body>
                            </html>
