...
<body>
    ...
    ?>
            ...
            <section>
                ...
                <div class="modal" id="asig">

                    <div class="modal_container">
                        <button type="button" class="desplegarModal btn-cerrar" modal="#asig"><img src="../../img/x.svg" alt="Salir" modal="#asig"></button>
                    ...
                    <div class="cont-filtro">
                        ...
                        <form method="get">
                            ...
                            <div class="fila-cont">
                                ...
                                <a href="adminAsig.php" class="filtrar">Limpiar</a>
