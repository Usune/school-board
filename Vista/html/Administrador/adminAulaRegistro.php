    ...
    ?>
        <main>
            ...
            <nav class="nav-main">
                ...
                <a href="adminAulasRegistro.php"> / Crear</a>
            </nav>
            ...
            <section>
                ...
                <div class="formulario">
                    ...
                    <p class="recordatorio">Antes de crear el aula, asegurese de que todos los campos son correctos.</p>
                    ...
                    <form action="../../../Controlador/registrarAulaAdmin.php" method="post" id="formulario">
                        ...
                        <button type="submit" class="enviar">Crear Aula</button>
                    </form>
                </div>
            </section>
